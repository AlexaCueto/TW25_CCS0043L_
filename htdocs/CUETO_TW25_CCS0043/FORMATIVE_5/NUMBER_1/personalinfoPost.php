...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(to right, #f8fbff,rgb(255, 229, 252));
            max-width: 750px;
            margin: 50px auto;
            padding: 20px;
            color: #2c3e50;
        ...
        form {
            ...
            padding: 30px;
            border-radius: 10px;
            box-shadow: 0 5px 15px rgba(81, 15, 72, 0.1);
        }
        ...
        input[type="submit"] {
            background-color:rgb(108, 26, 96);
            color: white;
            padding: 12px;
            width: 100%;
            border: none;
...
<body>
    ...
    <form method="post" action="personalinfoPost.php">
